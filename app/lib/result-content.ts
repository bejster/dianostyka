...
export const RESULT_CONTENT: Record<string, ResultPack> = {
  wieczorny_odpad: {
    ...
    heroSub: 'Robisz swoje, pilnujesz jedzenia, a i tak stoi, bo wszystko sypie się w jednym oknie, którego nie podejrzewasz. Zaraz Ci je pokażę, co do godziny.',
    ...
    costBody: 'Trzy rozwalone wieczory w tygodniu robią dwanaście dni na pół mocy w miesiącu, Zamknij to jedno okno, a te dni wracają. Razem z nimi trening, który wreszcie odkłada efekty, oraz głowa, która ciągnie równo do wieczora.',
    protocolHeadline: 'Przez 7 dni sprawdzasz tylko to jedno okno.',
    protocol: [
      { title: 'Rano: 10 minut światła w oczy', detail: 'W ciągu godziny po wstaniu wyjdź na balkon albo na krótki spacer. Poranne światło to sygnał, który ustawia wieczorny spadek kortyzolu, tego samego, który rano stawia Cię na nogi. Kawa tylko to maskuje. Bez niego rytm się rozjeżdża i wieczorem nie schodzisz.' },
      { title: 'Śniadanie: 30-40 g białka i tłuszcz', detail: '3-4 jajka zamiast płatków czy kanapki. Węgle na czczo podbijają cukier, a potem gwałtownie go zrzucają. Ten zjazd mózg czyta jako głód. Białko trzyma cukier płasko, więc po południu nie łapie Cię wilczy apetyt.' },
    ...
    closeBody: 'Wiesz już dokładnie, co robić od jutra, a to więcej, niż ma większość facetów na sali. Tego, kto taki protokół zna, od tego, kto ma go w ciele, dzieli jedno: ktoś, kto przez pierwszy tydzień trzyma Cię na kursie, kiedy jeszcze nic nie widać. I nie pozwala odpuścić, gdy głowa podpowiada, że jutro się nadrobi.',
  },
  ...
  weekend_reset: {
    ...
    heroSub: 'Przez tydzień robisz swoje, jedzenie ogarnięte, a wynik i tak stoi, bo wszystko, co budujesz przez pięć dni, rozjeżdża się na styku weekendu i poniedziałku. Zaraz Ci pokażę, czemu wtorek schodzi na nadrabianiu.',
    revealHeadline: 'Twój tydzień pęka w weekend, a płacisz w poniedziałek.',
    revealCaption: 'Poniedziałek do piątku trzymasz rytm, pobudka o stałej porze i posiłki na czas, a potem w sobotę śpisz dłużej, w niedzielę jeszcze dłużej i kładziesz się grubo po północy, więc ciało dostaje sygnał, że zmieniłeś strefę czasową. Poniedziałek z wtorkiem schodzą potem na wracaniu na tory.',
    ...
    closeBody: 'Wiesz już, co robić od jutra, tyle że w środę trening wypada o innej porze, w piątek ktoś proponuje wyjście, a w niedzielę budzik dzwoni i go klikasz. Zegar znów się rozjeżdża. Dlatego z facetami, których prowadzę, ustawiamy ten rytm pod ich tydzień, robotę i trening, a ja patrzę im na ręce przez ten pierwszy tydzień, aż weekend przestaje kasować formę.',
  },
  ...
  glowa_zajezdza: {
    ...
    experiment: {
      ...
      lookFor: 'Czy napięcie faktycznie spada po zamknięciu dnia, czy siedzi z Tobą do wieczora.',
      example: '18:00 · napięcie 7 · 19:00 · napięcie 6',
    },
    heroHeadline: 'Naucz głowę schodzić z obrotów, a reszta idzie za nią.',
    heroSub: 'Robisz swoje, pilnujesz jedzenia, a i tak stoi, bo wszystko sypie się wieczorem, w głowie, a potem ciągnie za sobą następny dzień. Zaraz Ci pokażę, o której godzinie się to włącza.',
  ...
  wiedza_bez_wdrozenia: {
    ...
    protocol: [
      ...
      { title: '2-minutowy przegląd wieczorem', detail: 'Dwie minuty przed snem: co domknięte, co nie, jedna rzecz na jutro. Potem zamykasz notatnik.' },
    ],
  ...
  silnik_bez_paliwa: {
    ...
    experiment: {
      ...
      lookFor: 'Czy skupienie się na jednym obszarze faktycznie rusza cały tydzień.',
    },
    heroHeadline: 'Zepnij trzy dźwignie na jednym zegarze, a bak wreszcie się napełnia.',
    heroSub: 'Robisz swoje, jedzenie ogarnięte, a bak i tak świeci na rezerwie od rana. Nic nie wywala się z hukiem, więc trudno namierzyć, gdzie ucieka, ale zaraz Ci pokażę, co pod spodem sączy Ci formę każdego dnia.',
    revealHeadline: 'Twój tydzień sączy się po równo, siedem dni z rzędu.',
    revealCaption: 'Szukasz tego jednego dnia, w którym się wywaliło. Nie znajdziesz go, bo strata rozkłada się równo po wszystkich siedmiu, a każdy dzień oddaje kawałek tak mały, że pojedynczo wygląda na nic, dopóki nie zsumujesz siedmiu i nie zobaczysz tygodnia na pół mocy.',
    ...
    protocol: [
      ...
      { title: 'Ostatnia kawa do 14:00', detail: 'Kofeina siedzi w krwi 6-8 godzin, więc kawa o 17:00 spłyca sen. Zasypiasz normalnie, a rano czujesz się jak po nieprzespanej nocy.' },
