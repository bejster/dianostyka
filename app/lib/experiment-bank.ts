...
export const EXPERIMENT_BANK: Record<ExperimentId, ExperimentDef> = {
  E1: {
    ...
    doNotChange: 'kalorie, cały jadłospis, suplementy, trening',
  ...
  E3: {
    ...
    doNotChange: 'ogólne kalorie ani cały system żywienia',
  ...
  G1: {
    ...
    doNotChange: 'rutynę snu, trening i jedzenie równocześnie',
  ...
  G2: {
    ...
    doNotChange: 'resztę wieczornej rutyny',
  ...
  G4: {
    ...
    doNotChange: 'całe zachowanie wieczorne',
  ...
  T2: {
    ...
    doNotChange: 'liczbę zaplanowanych sesji',
  ...
  T3: {
    ...
    doNotChange: 'cały harmonogram treningowy',
  ...
  W1: {
    ...
    doNotChange: 'resztę planu na weekend',
  ...
  W3: {
    ...
    doNotChange: 'weekend celowo, tylko żeby poprawić wynik',
  ...
  W4: {
    ...
    doNotChange: 'kilku zmiennych powrotu naraz',
  ...
  R2: {
    ...
    doNotChange: 'kalorie, plan treningowy, suplementy, aplikacje, protokół snu',
  ...
  R3: {
    ...
    doNotChange: 'porę snu, suplementy, kofeinę i pięć innych zmiennych snu naraz',
